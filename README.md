...
<nav class="w3-sidebar w3-collapse w3-white w3-animate-left" style="z-index:3;width:300px;" id="mySidebar"><br>
  <div class="w3-container">
    ...
    <img src="https://www.w3schools.com/w3images/profile_girl.jpg" style="width:45%;" class="w3-round"><br><br>
    <h4><b>RAJASREE</b></h4>
    <p class="w3-text-grey">FRONT-END DEVELOPER</p>
  </div>
...
<div class="w3-main" style="margin-left:300px">
  ...
  <!-- Header -->
  <header id="portfolio">
    <a href="#"><img src="https://www.w3schools.com/w3images/avatar_g.jpg" style="width:65px;" class="w3-circle w3-right w3-margin w3-hide-large w3-hover-opacity"></a>
